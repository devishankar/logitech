package com.github.devishankar.devishankarlogitech;
...
import com.github.devishankar.devishankarlogitech.Utils.Utils;
import com.github.devishankar.devishankarlogitech.adapter.DevicesListAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initRequest() {
        if (Utils.isAppOnline(context)) {
            ...
            Thread fetch = new FetchJson(handler);
            fetch.start();
    ...
    private class FetchJson extends Thread implements Runnable {
        ...
        public FetchJson(Handler handler) {
